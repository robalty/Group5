...
public class Provider extends Person {
    ...
    public int writeReport(File aFile) {
        ...
        if (result==1)
            try {
                result += this.serviceProvidedList.writeProviderReport(aFile);
            }catch(Exception e) {
            return 0;
        }
    return result;
    ...
    public int removeService(int toRemove) {
        return this.serviceList.search_and_delete_service_by_iD(toRemove);
    }
